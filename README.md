...
The database is organized logically by **4-character Wii Game IDs** (e.g., `SMNE`, `RMCP`).

```text
database/
├── [GAME_ID]/
│   └── icon_animated.png   # Authentic Wii Channel animation
└── WiiSave-Database.json   # Metadata and mapping file (Optional)
